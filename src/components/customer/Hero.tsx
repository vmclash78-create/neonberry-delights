...
export default function Hero({ onCtaClick }: HeroProps) {
  ...
  return (
    ...
    >
      <div className="relative z-10 gradient-chocolate px-6 py-10 md:py-16">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,hsl(35_80%_55%/0.2),transparent_50%)]" />
        <motion.div
